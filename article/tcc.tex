...
observar na \autoref{fig_async_cpu_usage}
...
\begin{figure}[!h]
\centering
\caption{Assíncrono com \textit{clusters}: Uso de memória \textit{RAM} X tempo}
...
\begin{figure}[!h]
\centering
\caption{Assíncrono com \textit{clusters}: Uso de \textit{CPU} X tempo}
