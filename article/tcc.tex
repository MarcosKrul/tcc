...
e o tempo médio em que o cliente consegue lidar os dados recebidos do servidor, ou seja, o tempo de recebimento do arquivo até
que o cliente esteja apto a manipulá-lo por completo.
...
o cliente necessita que o servidor envie os dados de uma forma adequada para sua recepção e exibição, caso contrário, este não funcionará corretamente
