...
de tempo - vazão) e a média do tempo de resposta do servidor. Uma implementação utilizará uma arquitetura não escalável e não 
...
com 10 . É evidente que, assim como
