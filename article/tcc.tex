...
\cite{ZRHR} devem processar arquivos com tamanhos na ordem de \textit{gigabytes}, de forma rápida e estável. 
Contudo, existem limitações inerentes ao uso da plataforma \textit{web}, como o processamento de 
diversas requisições que exijam esses arquivos, tratamento do alto fluxo de dados pela máquina 
...
e rápida para leitura, gravação e transformação de dados, de forma que é possível realizar encadeamento 
...
O modelo da arquitetura baseada em eventos do \textit{Node.JS} aumenta o poder de uso das \textit{streams}, visto que,
