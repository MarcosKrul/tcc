...
% ler um arquivo - definir tamanho, ex.: 50GB
% comparação - leitura badaras x leitura com arquitetura baseada em eventos
% métricas para comparação - uso de memória e tempo
% seção sobre a base de dados utilizada (dados, tamanho, link download)
